...
import { Clock, Dumbbell, Target, XCircle, Flame, ChevronRight } from 'lucide-react'
...
const editorialCols = [
  ...
  {
    label: 'Cardio',
    workouts: workouts.filter(w => w.goal === 'cardio' || w.goal === 'weight-loss').slice(0, 4),
  },
  {
    label: 'Muscle & Flex',
    workouts: workouts.filter(w => w.goal === 'muscle' || w.goal === 'flexibility').slice(0, 4),
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        ...
        {filtered.length > 0 ? (
          ...
          <div className="text-center py-24 bg-zinc-900/30 rounded-3xl border border-zinc-800/30 backdrop-blur-sm">
            ...
            <p className="text-lg font-semibold text-zinc-400">No workouts match your filters</p>
            <button
  ...
  return (
    <div className="bg-zinc-950 min-h-screen text-zinc-100 font-sans">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-[70vh]">
            ...
            <div className="flex flex-col justify-center order-2 lg:order-1 pt-12 lg:pt-0">
              ...
              <h1 className="fade-up-2 font-display text-6xl sm:text-7xl lg:text-8xl font-black leading-[1.05] tracking-tight text-white mb-6">
                NO <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500">EXCUSES.</span>
                <br />
                START NOW.
              </h1>

              <p className="fade-up-3 text-lg text-zinc-400 leading-relaxed max-w-lg mb-10 font-medium">
                Free workouts matched in seconds. No gym, no equipment, no barriers. Pick your goal and transform your life today.
              </p>
              ...
              <div className="flex items-center gap-4 flex-wrap fade-up-4">
                <span className="text-xs uppercase tracking-widest text-zinc-600 font-bold mr-2">Quick Pick:</span>
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="bg-zinc-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-5 shadow-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-bold tracking-tight">Personalized For You</h4>
                      <p className="text-zinc-300 text-sm">Over 50+ exercises combined for maximum results.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="border-y border-zinc-800/50 bg-zinc-950/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-zinc-800/50">
            {[
              { num: '50', suffix: '+', highlight: true, label: 'Exercises in Library' },
              { num: '12', suffix: '', label: 'Curated Workouts' },
              { num: '3',  suffix: '', label: 'Full Programs' },
            ].map(stat => (
              <div key={stat.label} className="py-8 text-center flex flex-col justify-center">
                <div className="font-display text-4xl sm:text-5xl font-black mb-2 tracking-tight">
                  <span className={stat.highlight ? "text-orange-500" : "text-white"}>{stat.num}</span>
                  <span className={stat.highlight ? "text-orange-500" : "text-zinc-500"}>{stat.suffix}</span>
                </div>
      ...
      <section className="py-20 bg-zinc-950 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-baseline justify-between mb-12">
            <h2 className="font-display text-3xl font-bold text-white tracking-tight">Browse Quick Collections</h2>
            <span className="text-xs text-zinc-500 uppercase tracking-widest font-bold hidden sm:inline-block">Curated by goal</span>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {editorialCols.map((col) => (
              <div key={col.label} className="bg-zinc-900/40 rounded-3xl p-6 border border-zinc-800/50 shadow-sm transition hover:shadow-lg hover:border-zinc-700/50">
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader title="Featured Workout" subtitle="Start here if you are not sure where to begin." />
            ...
            <div className="p-8 sm:p-12 lg:col-span-3 flex flex-col justify-center relative">
              ...
              <div className="flex flex-wrap items-center gap-6 mb-8">
                <div className="flex items-center gap-2 text-sm font-semibold text-zinc-300">
                  <div className="p-2 bg-zinc-800 rounded-full text-orange-500"><Clock className="w-4 h-4" /></div>
                  {featuredWorkout.duration} min
                </div>
                <div className="flex items-center gap-2 text-sm font-semibold text-zinc-300 capitalize">
                  <div className="p-2 bg-zinc-800 rounded-full text-orange-500"><Dumbbell className="w-4 h-4" /></div>
                  {featuredWorkout.equipment}
                </div>
                <div className="flex items-center gap-2 text-sm font-semibold text-zinc-300 capitalize">
                  <div className="p-2 bg-zinc-800 rounded-full text-orange-500"><Target className="w-4 h-4" /></div>
              ...
              <div className="mb-8 bg-zinc-900/50 rounded-2xl p-6 border border-zinc-800/50">
                {featuredWorkout.exercises.slice(0, 3).map((ex, i) => (
                  <div key={i} className="flex items-center justify-between py-3 border-b border-zinc-800/80 last:border-0 last:pb-0 first:pt-0">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-semibold text-zinc-200 capitalize">{ex.exerciseId.replace(/-/g, ' ')}</span>
                    </div>
      ...
      <section className="py-24 bg-zinc-900/20 border-y border-zinc-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader title="How It Works" subtitle="From zero to workout in under 60 seconds." />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {howItWorks.map((step, idx) => (
              <div key={step.num} className="bg-zinc-900/50 backdrop-blur-sm rounded-3xl p-8 border border-zinc-800 hover:border-zinc-700 transition-colors shadow-lg shadow-black/20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <HorizontalScroll>
            {exercises.map(exercise => (
              <div key={exercise.id} className="shrink-0 w-64 md:w-72 pl-4 first:pl-0">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden p-12 lg:p-20 text-center rounded-[3rem] bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 shadow-2xl shadow-orange-500/10">
            ...
            <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-6 uppercase tracking-tight">
              Not sure<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500">where to start?</span>
            </h2>
            <p className="text-lg text-zinc-400 max-w-md mx-auto mb-10 font-medium">
              Hit shuffle and get moving — no planning required. Let's build momentum.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {commonMistakes.map(mistake => (
              <div key={mistake.title} className="bg-zinc-900/80 rounded-3xl p-8 border border-zinc-800/50 relative overflow-hidden group hover:border-zinc-700/50 transition-colors shadow-lg shadow-black/20">
      ...
      <section className="py-32 border-t border-zinc-800/50 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h2 className="font-display text-5xl sm:text-6xl font-black text-white leading-tight tracking-tight mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500">FITNESS JOURNEY?</span>
          </h2>
          <p className="text-xl text-zinc-400 mb-12 font-medium">
            No gym, no excuses, no barriers. Start moving today and feel the difference.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <Link href="/programs" className="btn-primary w-full sm:w-auto text-center px-10 py-4 text-base">
              View Programs
            </Link>
            <Link href="/workout" className="btn-ghost w-full sm:w-auto text-center px-10 py-4 text-base bg-zinc-900/50 backdrop-blur-sm">
              Browse Workouts
            </Link>
          </div>
        </div>
