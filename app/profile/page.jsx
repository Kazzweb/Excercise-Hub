...
function calcTDEE(bmr, activityLevel) {
  const factor =
    ACTIVITY_LEVELS.find((a) => a.id === activityLevel)?.factor ?? 1.55;
...
export default function ProfilePage() {
  ...
  const bmr = canCalc
    ...
    : null;
  const tdee =
    bmr && form?.activityLevel ? calcTDEE(bmr, form.activityLevel) : null;
  const bmi =
  ...
  async function handleSave() {
    ...
    try {
      const a = Number(form.age),
        h = Number(form.heightCm),
        w = Number(form.weightKg);
    ...
    >
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14'>
        ...
        <div className='mb-12'>
          ...
          >
            YOUR{' '}
            <em style={{ fontStyle: 'normal', color: '#e8190c' }}>PROFILE</em>
          </h1>
          <p
            style={{
          ...
          >
            Update your stats anytime — your calorie targets and workout
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
          ...
          <div className='flex flex-col gap-4'>
                  ...
                  {[
                    {
                      label: 'Lose weight',
                      kcal: tdee - 500,
                      note: '500 kcal deficit',
                    },
                    { label: 'Maintain', kcal: tdee, note: 'Maintenance' },
                    {
                      label: 'Build muscle',
                      kcal: tdee + 300,
                      note: '300 kcal surplus',
                    },
                  ].map((t) => (
                    <div
                      key={t.label}
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          fontSize: '1.3rem',
                          color:
                            t.label === 'Maintain' ? '#e8190c' : 'var(--text)',
                          lineHeight: 1,
                        }}
                      >
                        {t.kcal}
            ...
            >
              Calculated using the Mifflin-St Jeor equation — the most
              clinically validated BMR formula (±10% accuracy for most adults).
            </p>
          </div>
        </div>
      </div>
...
function StatCard({
  ...
  return (
    <div
      style={{
        border: `1px solid ${highlight ? 'rgba(232,25,12,0.3)' : 'var(--border)'}`,
        background: highlight ? 'rgba(232,25,12,0.04)' : 'transparent',
        padding: '1rem',
      }}
    >
      <p
      ...
      <div className='flex items-baseline gap-2 mt-1'>
        <span
          style={{
            fontFamily: 'var(--font-display)',
            fontSize: '2rem',
            color: highlight ? '#e8190c' : 'var(--text)',
            lineHeight: 1,
          }}
        >
          {value}
...
function chipStyle(active, variant) {
  return {
    ...
    border: active
      ? `2px solid ${variant === 'red' ? '#e8190c' : '#0c0c0c'}`
      : '1px solid var(--border)',
    background: active
      ? variant === 'red'
        ? 'rgba(232,25,12,0.08)'
